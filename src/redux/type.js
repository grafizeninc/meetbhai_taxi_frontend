...
export const GET_VEHICLE_BY_AIRPORT_AND_DESTINATION = "GET_VEHICLE_BY_AIRPORT_AND_DESTINATION";
export const ADD_AIRPORT_BOOKING = "ADD_AIRPORT_BOOKING";
export const UPDATE_BOOKING = "UPDATE_BOOKING";
export const DELETE_BOOKING = "DELETE_BOOKING";

//LocalBooking
export const GET_ALL_LOCAL_BOOKING = "GET_ALL_LOCAL_BOOKING";
export const GET_VEHICLE_BY_LOCAL_PACKAGES = "GET_VEHICLE_BY_LOCAL_PACKAGES";
export const ADD_LOCAL_BOOKING = "ADD_LOCAL_BOOKING";
export const UPDATE_LOCAL_BOOKING = "UPDATE_LOCAL_BOOKING";
export const DELETE_LOCAL_BOOKING = "DELETE_LOCAL_BOOKING";
...
export const GET_DESTINATION_BY_AIRPORT = "GET_DESTINATION_BY_AIRPORT";
